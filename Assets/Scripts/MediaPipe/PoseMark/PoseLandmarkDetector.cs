...
namespace Mediapipe.Unity.Yupopyoi.PoseLandmark
{
    public class PoseLandmarkDetector : VisionTaskApiRunner<PoseLandmarker>
    {
        [SerializeField] private PoseLandmarkerResultProvider _poseLandmarkerResultProvider;
        ...
        protected override IEnumerator Run()
        {
            ...
            SetupAnnotationController(_poseLandmarkerResultProvider, imageSource);
            _poseLandmarkerResultProvider.InitScreen(imageSource.textureWidth, imageSource.textureHeight);
            ...
            while (true)
            {
                ...
                switch (taskApi.runningMode)
                {
                    case Tasks.Vision.Core.RunningMode.IMAGE:
                        ...
                        {
                            _poseLandmarkerResultProvider.DrawNow(result);
                        }
                        else
                        {
                            _poseLandmarkerResultProvider.DrawNow(default);
                        }
                        break;
        ...
        private void OnPoseLandmarkDetectionOutput(PoseLandmarkerResult result, Image image, long timestamp) => _poseLandmarkerResultProvider.DrawLater(result);
